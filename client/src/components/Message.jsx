    ...
    <div>
      {message.role === "user" ? (
        <div className='flex items-start justify-end my-4 gap-2'>
          <div className='flex flex-col gap-2 p-2 px-4 bg-slate-50 dark:bg-[#33317c]/30 border
      ...
      (
          ...
          <span className='text-xs text-gray-400 dark:text-[#a6afc0]'>{moment(message.timestamp).fromNow()}</span>
          </div>
      )
    }
    </div>
